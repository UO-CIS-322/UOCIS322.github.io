...
In the following sections, we look first at the basic structure of HTML, then at how we add styling \(typefaces, colors, etc\) and page layout with a style sheet, and finally how we can use Javascript to interact more responsively with the user. 
